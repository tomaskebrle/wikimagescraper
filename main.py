...
# Label
Label(window, text='POZNÁVAČKA MAKER 3000', font='none 32 bold').grid(
    row=0, column=0, sticky=W, padx=20)

# Název kytky
Label(window, text='Název kytky rostliny atd.', font='none 11').grid(
    row=7, column=0, sticky=W, padx=20)
nazev = Entry(window, width=80, )
nazev.grid(row=9, column=0, sticky=W, padx=20)

# Submit
Button(window, text='POTVRDIT', width='6', command=click).grid(
    row=11, column=0, sticky=W, padx=20)
